...
public class BlogUserServiceImpl implements UserDetailsService {
    ...
    public static User fromEntity(BlogUser blogUser){
        return new User(blogUser.getUsername(),blogUser.getPassword(), getAuthorities(blogUser.getRole()));
    }

    private BlogUser toEntity(String username,String password){
